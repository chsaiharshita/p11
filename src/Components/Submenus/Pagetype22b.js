...
function Pagetype22b() {
  return (
    <div>
      {data.Pagetype22b.map((information) => {
        return (
            ...
            <div className="content">
              ...
              {information.detailservices.map((content) => {
                return (
                 ...
                 <th style={{width:"30%"}} >{content.Authority}</th>
                 <th style={{width:"45%"}}>{content.Trainingwing}</th>
